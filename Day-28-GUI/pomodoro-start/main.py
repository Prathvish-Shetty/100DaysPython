...
# dynamic typing : datatype changes when data insode variable changes python is a strongly dynamically typed language
# Strong typing means that the type of a value doesn't change in unexpected ways. A string containing only digits
